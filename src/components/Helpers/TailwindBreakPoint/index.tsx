...
export default function TailwindBreakpoint() {
  return (
    <div className='fixed bottom-0 right-0 flex items-center p-2 m-2 text-sm text-pink-600 bg-gray-300 border border-gray-400 rounded'>
      <svg className='inline w-auto h-6' viewBox='0 0 80 64' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path
      ...
      <span className='hidden ml-1 font-extrabold xl:inline 2xl:hidden'>xl</span>
      <span className='hidden ml-1 font-extrabold 2xl:inline 4xl:hidden'>2xl</span>
